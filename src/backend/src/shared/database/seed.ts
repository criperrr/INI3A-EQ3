...
export async function seedDatabase() {
  ...
  const defaultCustomizationItems = [
    // Banners
    {
      ...
      name: "Presco Selva",
      category: "banner",
      description: "Folhas tropicais clássicas do Presco em tom verde esmeralda.",
      price: 0,
      minLevel: 1,
      previewValue: "jungle",
    ...
    },
    {
      ...
      name: "Neon Cyberpunk",
      category: "banner",
      description: "Luzes de neon ciano e magenta com estilo futurista.",
      price: 100,
      minLevel: 2,
    ...
    },
    {
      ...
      category: "banner",
      description: "Gradiente aconchegante de entardecer âmbar e coral.",
      price: 150,
      minLevel: 2,
      previewValue: "sunset",
    ...
    {
      id: 4,
      name: "Obsidiana Noturna",
      category: "banner",
      description: "Fundo escuro acetinado com sutis reflexos violeta e constelações.",
      price: 250,
      minLevel: 3,
    ...
    },
    {
      ...
      name: "Aurora Boreal",
      category: "banner",
      description: "Ondas cósmicas de luz verde e turquesa brilhantes.",
      price: 400,
      minLevel: 4,
      previewValue: "aurora",
    ...
    },
    {
      ...
      name: "Ouro Imperial",
      category: "banner",
      description: "Gradiente luxuoso de ouro nobre com partículas reluzentes.",
      price: 800,
      minLevel: 5,
      previewValue: "gold",
    ...
    {
      id: 7,
      name: "Cósmico Nebulosa",
      category: "banner",
      description: "Espaço profundo com nebulosa roxa estelar.",
      price: 1200,
      minLevel: 6,
      previewValue: "nebula",
