...
Kit version: `2026.9.4` · 18 agents · 41 skills · 13 workflows
...
flowchart LR
  ...
  subgraph Skills
    ...
    S_presco_backend["presco-backend"]
    S_presco_frontend["presco-frontend"]
  ...
  A_backend_specialist --> S_presco_backend
  ...
  A_frontend_specialist --> S_presco_frontend
  ...
  A_mobile_developer --> S_presco_frontend
  ...
  A_security_auditor --> S_presco_backend
