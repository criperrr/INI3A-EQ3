...
Kit version: `2026.8.15` · 20 agents · 60 skills · 13 workflows
...
flowchart LR
  ...
  subgraph Skills
    S_antigravity_skills_manager["antigravity-skills-manager"]
    S_api_design_principles["api-design-principles"]
    S_api_patterns["api-patterns"]
    S_app_builder["app-builder"]
    S_architecture["architecture"]
    S_backend["backend"]
    S_backend_security_coder["backend-security-coder"]
    ...
    S_code_review_ai_ai_review["code-review-ai-ai-review"]
    ...
    S_database_architect["database-architect"]
    ...
    S_error_debugging_error_analysis["error-debugging-error-analysis"]
    S_frontend["frontend"]
    ...
    S_nodejs_backend_patterns["nodejs-backend-patterns"]
    ...
    S_react_native_architecture["react-native-architecture"]
    ...
    S_typescript_pro["typescript-pro"]
    S_unit_testing_test_generate["unit-testing-test-generate"]
