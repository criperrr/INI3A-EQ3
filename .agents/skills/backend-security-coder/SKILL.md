...
description: Expert in secure backend coding practices specializing in input validation, authentication, JWT handling, Redis blacklist, and API security.
when_to_use: "When implementing or auditing authentication, JWT verification, input validation, SQL injection defense, and OWASP security practices."
