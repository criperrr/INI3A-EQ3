...
description: Systematic error analysis and debugging specialist for analyzing stack traces, production incidents, and resolving root causes.
when_to_use: "When investigating unhandled exceptions, analyzing stack traces, debugging Redis/Postgres connection issues, or fixing HTTP errors."
